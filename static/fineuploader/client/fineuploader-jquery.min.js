...
qq.DragAndDrop=function(a){function b(){j===k&&!g&&(e.callbacks.log("Grabbed "+h.length+" files after tree traversal."),f.dropDisabled(!1),e.callbacks.dropProcessing(!1,h))}function c(a){var e;j+=1;a.isFile?a.file(function(a){h.push(a);k+=1;b()}):a.isDirectory&&(g=!0,a=a.createReader(),a.readEntries(function(a){k+=1;for(e=0;e<a.length;e+=1)c(a[e]);g=!1;a.length||b()}))}function d(a){f=new qq.UploadDropZone({element:a,onEnter:function(b){qq(a).addClass(e.classes.dropActive);b.stopPropagation()},onLeaveNotDescendants:function(){qq(a).removeClass(e.classes.dropActive)},
onDrop:function(d){e.hideDropzones&&qq(a).hide();qq(a).removeClass(e.classes.dropActive);d=d.dataTransfer;var g,m;e.callbacks.dropProcessing(!0);f.dropDisabled(!0);if(1<d.files.length&&!e.multiple)e.callbacks.error("tooManyFilesError","");else if(h=[],k=j=0,qq.isFolderDropSupported(d)){g=d.items;for(d=0;d<g.length;d+=1)if(m=g[d].webkitGetAsEntry())m.isFile?(h.push(g[d].getAsFile()),d===g.length-1&&b()):c(m)}else e.callbacks.dropProcessing(!1,d.files),f.dropDisabled(!1)}});l.addDisposer(function(){f.dispose()});
e.hideDropzones&&qq(a).hide()}var e,f,g,h=[],j=0,k=0,l=new qq.DisposeSupport;e={dropArea:null,extraDropzones:[],hideDropzones:!0,multiple:!0,classes:{dropActive:null},callbacks:{dropProcessing:function(){},error:function(){},log:function(){}}};qq.extend(e,a);return{setup:function(){e.dropArea&&e.extraDropzones.push(e.dropArea);var a,b=e.extraDropzones;for(a=0;a<b.length;a+=1)d(b[a]);e.dropArea&&(!qq.ie()||qq.ie10())&&l.attach(document,"dragenter",function(c){var d;if(d=!f.dropDisabled()){var j;qq.each(c.dataTransfer.types,
function(a,b){if("Files"===b)return j=!0,!1});d=j}if(d&&!qq(e.dropArea).hasClass(e.classes.dropDisabled)){e.dropArea.style.display="block";for(a=0;a<b.length;a+=1)b[a].style.display="block"}});l.attach(document,"dragleave",function(c){if(e.hideDropzones&&qq.FineUploader.prototype._leaving_document_out(c))for(a=0;a<b.length;a+=1)qq(b[a]).hide()});l.attach(document,"drop",function(c){if(e.hideDropzones)for(a=0;a<b.length;a+=1)qq(b[a]).hide();c.preventDefault()})},setupExtraDropzone:function(a){e.extraDropzones.push(a);
d(a)},removeExtraDropzone:function(a){var b,c=e.extraDropzones;for(b in c)if(c[b]===a)return c.splice(b,1)},dispose:function(){l.dispose();f.dispose()}}};
qq.UploadDropZone=function(a){function b(){return qq.safari()||qq.firefox()&&qq.windows()}function c(a){if(qq.ie()&&!qq.ie10())return!1;var b=a.dataTransfer,c=qq.safari();a=qq.ie10()?!0:"none"!==b.effectAllowed;return b&&a&&(b.files||!c&&b.types.contains&&b.types.contains("Files"))}function d(a){void 0!==a&&(f=a);return f}var e,f,g,h=new qq.DisposeSupport;e={element:null,onEnter:function(){},onLeave:function(){},onLeaveNotDescendants:function(){},onDrop:function(){}};qq.extend(e,a);a=e.element;g||
(b?h.attach(document,"dragover",function(a){a.preventDefault()}):h.attach(document,"dragover",function(a){a.dataTransfer&&(a.dataTransfer.dropEffect="none",a.preventDefault())}),g=!0);h.attach(a,"dragover",function(a){if(c(a)){var b=qq.ie()?null:a.dataTransfer.effectAllowed;a.dataTransfer.dropEffect="move"===b||"linkMove"===b?"move":"copy";a.stopPropagation();a.preventDefault()}});h.attach(a,"dragenter",function(a){if(!d()&&c(a))e.onEnter(a)});h.attach(a,"dragleave",function(a){if(c(a)){e.onLeave(a);
var b=document.elementFromPoint(a.clientX,a.clientY);if(!qq(this).contains(b))e.onLeaveNotDescendants(a)}});h.attach(a,"drop",function(a){!d()&&c(a)&&(a.preventDefault(),e.onDrop(a))});return{dropDisabled:function(a){return d(a)},dispose:function(){h.dispose()}}};
...
delete this._detach_load_events[a];if(a=document.getElementById(a))a.setAttribute("src","javascript:false;"),qq(a).remove()},_upload:function(a){this._options.onUpload(a,this.getName(a),!1);var b=this._inputs[a];if(!b)throw Error("file with passed id was not added, or already uploaded or cancelled");var c=this.getName(a),d=this._createIframe(a),e=this._createForm(d,this._options.paramsStore.getParams(a));e.appendChild(b);var f=this;this._attachLoadEvent(d,function(){f.log("iframe loaded");var b=f._getIframeContentJSON(d);
setTimeout(function(){f._detach_load_events[a]();delete f._detach_load_events[a];qq(d).remove()},1);if(b.success||!f._options.onAutoRetry(a,c,b))f._options.onComplete(a,c,b),f._dequeue(a)});this.log("Sending upload request for "+a);e.submit();qq(e).remove();return a},_attachLoadEvent:function(a,b){var c=this;this._detach_load_events[a.id]=qq(a).attach("load",function(){c.log("Received response for "+a.id);if(a.parentNode){try{if(a.contentDocument&&a.contentDocument.body&&"false"==a.contentDocument.body.innerHTML)return}catch(d){c.log("Error when attempting to access iframe during handling of upload response ("+
...
arguments);this._files=[];this._xhrs=[];this._loaded=[]},_upload:function(a){var b=this._files[a],c=this.getName(a);this.getSize(a);var d=this,e=this._options.endpoint,f=this._options.demoMode?"GET":"POST",g,h,j;this._options.onUpload(a,this.getName(a),!0);this._loaded[a]=0;g=this._xhrs[a]=new XMLHttpRequest;g.upload.onprogress=function(b){b.lengthComputable&&(d._loaded[a]=b.loaded,d._options.onProgress(a,c,b.loaded,b.total))};g.onreadystatechange=function(){4===g.readyState&&d._onComplete(a,g)};
j=this._options.paramsStore.getParams(a);this._options.paramsInBody||(j[this._options.inputName]=c,e=qq.obj2url(j,this._options.endpoint));g.open(f,e,!0);g.setRequestHeader("X-Requested-With","XMLHttpRequest");g.setRequestHeader("X-File-Name",encodeURIComponent(c));g.setRequestHeader("Cache-Control","no-cache");this._options.forceMultipart||this._options.paramsInBody?(e=new FormData,this._options.paramsInBody&&qq.obj2FormData(j,e),e.append(this._options.inputName,b),b=e):(g.setRequestHeader("Content-Type",
"application/octet-stream"),g.setRequestHeader("X-Mime-Type",b.type));for(h in this._options.customHeaders)this._options.customHeaders.hasOwnProperty(h)&&g.setRequestHeader(h,this._options.customHeaders[h]);this.log("Sending upload request for "+a);g.send(b)},_onComplete:function(a,b){if(this._files[a]){var c=this.getName(a),d=this.getSize(a),e;this._options.onProgress(a,c,d,d);this.log("xhr - server response received for "+a);this.log("responseText = "+b.responseText);try{e="function"===typeof JSON.parse?
JSON.parse(b.responseText):eval("("+b.responseText+")")}catch(f){this.log("Error when attempting to parse xhr response text ("+f+")","error"),e={}}if(200===b.status&&e.success||!this._options.onAutoRetry(a,c,e,b))this._options.onComplete(a,c,e,b),this._xhrs[a]=null,this._dequeue(a)}},_cancel:function(a){this._options.onCancel(a,this.getName(a));this._files[a]=null;this._xhrs[a]&&(this._xhrs[a].abort(),this._xhrs[a]=null)}});
(function(a){var b,c,d,e,f,g,h,j,k,l;g=["uploaderType"];d=function(a){a&&(a=j(a),h(a),"basic"===f("uploaderType")?b(new qq.FineUploaderBasic(a)):b(new qq.FineUploader(a)));return c};e=function(a,b){var d=c.data("fineuploader");if(b)void 0===d&&(d={}),d[a]=b,c.data("fineuploader",d);else return void 0===d?null:d[a]};b=function(a){return e("uploader",a)};f=function(a,b){return e(a,b)};h=function(b){var d=b.callbacks={};a.each((new qq.FineUploaderBasic)._options.callbacks,function(a){var b,e;b=/^on(\w+)/.exec(a)[1];
b=b.substring(0,1).toLowerCase()+b.substring(1);e=c;d[a]=function(){var a=Array.prototype.slice.call(arguments);return e.triggerHandler(b,a)}})};j=function(b,d){var e,h;e=void 0===d?"basic"!==b.uploaderType?{element:c[0]}:{}:d;a.each(b,function(b,c){0<=a.inArray(b,g)?f(b,c):c instanceof a?e[b]=c[0]:a.isPlainObject(c)?(e[b]={},j(c,e[b])):a.isArray(c)?(h=[],a.each(c,function(b,c){c instanceof a?a.merge(h,c):h.push(c)}),e[b]=h):e[b]=c});if(void 0===d)return e};k=function(c){return"string"===a.type(c)&&
!c.match(/^_/)&&void 0!==b()[c]};l=function(a){var c=[],d=Array.prototype.slice.call(arguments,1);j(d,c);return b()[a].apply(b(),c)};a.fn.fineUploader=function(e){var f=this,g=arguments,h=[];this.each(function(j,n){c=a(n);if(b()&&k(e)){if(h.push(l.apply(f,g)),1===f.length)return!1}else"object"===typeof e||!e?d.apply(f,g):a.error("Method "+e+" does not exist on jQuery.fineUploader")});return 1===h.length?h[0]:1<h.length?h:this}})(jQuery);